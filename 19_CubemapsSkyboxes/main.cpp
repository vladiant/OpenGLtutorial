...
int main() {
  ...
  std::string modelPath = "/airplane/scene.gltf";
  ...
  std::string facesCubemap[6] = {
      parentDir + "/skybox/right.jpg", parentDir + "/skybox/left.jpg",
      parentDir + "/skybox/top.jpg",   parentDir + "/skybox/bottom.jpg",
      parentDir + "/skybox/front.jpg", parentDir + "/skybox/back.jpg"};
